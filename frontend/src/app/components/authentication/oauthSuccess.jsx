    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#030303] flex items-center justify-center px-4">
            <div className="text-center">
                ...
                {status === "processing" && (
                    <div>
                        <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Signing you in...</h2>
                ...
                {status === "success" && (
                    <div>
                        <h2 className="text-xl font-bold text-green-600 dark:text-green-400 mb-2">Success!</h2>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Redirecting you to dashboard...</p>
                    </div>
                )}
                ...
                {status === "error" && (
                    <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">Redirecting you back to login...</p>
                    </div>
                )}
            </div>
        </div>
