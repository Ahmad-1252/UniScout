...
export const initializeAuth = async () => {
  try {
    ...
    try {
      ...
      // Return flag to indicate token expiration occurred
      return { authenticated: false, user: null, tokenExpired: true };
    }
...
export const completeProfileSetup = async () => {
  try {
    const response = await apiClient.post(API_ENDPOINTS.COMPLETE_PROFILE_SETUP);
